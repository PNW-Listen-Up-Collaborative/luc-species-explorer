...
The previous layout: one chart at a time, chosen from a picker, with the
filters in cards across the top. Superseded by app.py (the sidebar layout) but
kept because it still has controls that one dropped: Compare by, the per-day
scale toggle, and the map's season scrubber.
